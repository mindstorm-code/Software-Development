...
public class Exercise17_07 {
    ...
    public static void main(String[] args) {
        ...
        // 1⃣ Write Loan objects to the file
        writeLoans(filename);

        // 2⃣ Read them back and display total amount
        outputData(filename);
    }

    // This method writes some Loan objects to Exercise17_07.dat
    // NOTE: This overwrites the file each time. If your starter file appends,
    // you could adapt to append mode, but typical book solution overwrites.
    ...
    // This is the method your assignment asks you to add:
    // "reads the Loan objects from the file and displays the total loan amount"
    // We don't know how many Loan objects are in the file,
    // so we loop until EOFException.
